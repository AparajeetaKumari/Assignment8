...
public class Assignment8 {
	...
	public void verifyText() {
		...
		Assert.assertTrue(textDisplayedOnPage.getText().equals("Facebook helps you connect and share with the people in your life."));
	...
	public void verifyCreateAccountUsingXpath() {
		...
		Assert.assertNotNull(driver.findElement(By.xpath("//div[contains(text(),'Sign Up')]")));
